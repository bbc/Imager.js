...
module.exports = function (config) {
    var isCI =
        (Boolean(process.env.CI) &&
            Boolean(process.env.BROWSER_STACK_ACCESS_KEY)) === true;
    ...
    config.set({
        ...
        files: [
            ...
            'test/unit/**/*.js',
            {
                pattern: 'demos/grunt/Assets/Images/**/*.jpg',
                included: false,
                served: true,
            },
            {
            ...
            {
                pattern: 'test/fixtures/oldformat/*',
                included: false,
                served: true,
            },
        ],
        ...
        browserStack: {
            ...
            build: process.env.CONTINUOUS_INTEGRATION
                ? null
                : 'Local testing - ' + Date.now(),
        },
